...
-->
  ...
  <ul class="presets">
    ...
    <li class="<?php print drupal_html_class($preset->key);?>"><?php print l('<span class="color-style" style="background-color:' . $preset->base_color . '"></span><span class="color-main" style="background-color:' . $preset->link_color . '"></span>', 'drupalexp/preset/' . ($k + 1), array('html' => true,'query'=>array('destination'=>$current_path))); ?></li>
    <?php endforeach; ?>
  </ul>
<!--
  <h3>Background</h3>
